...
from pyflink.common.serialization import DeserializationSchema, Encoder, SerializationSchema, \
    KafkaRecordSerializationSchema, RMQDeserializationSchema
...
class KafkaSourceBuilder:
    ...
    def set_topics(self, topics) -> 'KafkaSourceBuilder':
        self.builder_obj.setTopics(topics)
        return self
    ...
    def build(self) -> 'KafkaSource':
        return KafkaSource(self.builder_obj.build())
...
class KafkaSource(Source):
    ...
    def __init__(self, j_kafka_source):
        super(KafkaSource, self).__init__(source=j_kafka_source)
...
class KafkaSinkBuilder:
    ...
    def build(self) -> 'KafkaSink':
        return KafkaSink(self.builder_obj.build())
